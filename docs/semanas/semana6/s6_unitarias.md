...
En aquellas historias que se indique en la [distribución de funcionalidades por semana](./../semana5/MT1PEA-PlanDesarrolloHistorias202514.md), el equipo debe usar pair programming para su desarrollo.
